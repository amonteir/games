...
1. [Tictactoe](https://en.wikipedia.org/wiki/Tic-tac-toe)
   ...
   * [GUI version](https://github.com/amonteir/games/tree/master/tictactoe_gui): Built on top of the console version but now with a  graphical interface using [SDL](https://www.libsdl.org/). Added C++11 features like a stack to control the game loop, auto, tuples, and enum classes for code readibility and manipulation. Work in progress: improve main menu, add notifications like player won/computer won etc, add audio, improve images, and add error log file.
2. Pac-Man
